...
pkg_install "sway" \
  "sway swaybar swaylock wayvnc kanshi mako remmina zathura gammastep kvantum-qt5 arc-gtk-theme papirus-icon-theme ydotool bitwarden-cli swappy grim slurp" \
  "-"
